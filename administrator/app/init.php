...
require_once '..'.DS.'app'.DS.'core'.DS.'Model.php';
require_once '..'.DS.'app'.DS.'core'.DS.'View.php';
require_once '..'.DS.'app'.DS.'core'.DS.'Controller.php';
require_once '..'.DS.'app'.DS.'core'.DS.'Router.php';
